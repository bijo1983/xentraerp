                    ...
                    <div className="flex items-center gap-3 mt-2 md:mt-0">
                      ...
                      {owner && (
                        <>
                          ...
                          <button
                            className="p-1 ml-1 rounded hover:bg-background-subtle"
            ...
            <form onSubmit={handleFormSave} className="space-y-4">
              ...
              <div className="flex gap-2 mt-4">
                ...
                <button
                  type="button"
                  onClick={closeForm}
                  className="border border-background-subtle bg-background-subtle text-text-primary px-4 py-2 rounded hover:bg-background"
                >
                  Cancel
                </button>
              </div>
