    ...
    >
      <div className="flex h-14 items-center justify-between border-b px-3 shrink-0">
        <div className="flex items-center gap-2 min-w-0">
          <Image src="/brand/mark.png" alt="XentraERP" width={24} height={24} className="rounded-md shrink-0" />
          {sidebarOpen && <span className="text-base font-bold tracking-tight truncate">XentraERP</span>}
        </div>
